...
const agentic_ai: ConceptDetail = {    id: 'agentic-ai',
    name: '代理式AI',
    nameEn: 'Agentic AI',
    ...
    detail: {
      ...
      resources: [
        ...
        {title: 'McKinsey 2025 AI State Report', url: 'https://www.mckinsey.com/industries/technology/our-insights/the-state-of-ai', type: 'article', language: 'en', difficulty: 'intermediate', recommended: true},
      ],
    },
};

export default agentic_ai;
