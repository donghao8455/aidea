...
const computer_vision: ConceptDetail = {
  id: 'computer-vision',
  name: '计算机视觉',
  ...
  difficulty: 2,
  tags: ['图像识别', '视觉', 'CNN'],
  tooltip: {summary: '教机器像人眼一样看懂图片和视频，是 AI 领域的重要概念'},
  detail: {
    definition: '计算机视觉（Computer Vision，缩写 CV）是 AI 领域的重要概念之一。教机器像人眼一样看懂图片和视频。计算机视觉 在现代大语言模型、深度学习应用中扮演关键角色，是开发者、研究者和爱好者必须了解的基础知识。掌握 计算机视觉 的核心原理有助于深入理解 AI 系统的设计哲学和实现方法。',
    plainExplanation: '想象一下，教机器像人眼一样看懂图片和视频。这就是 计算机视觉 的核心思想。计算机视觉 不是什么神秘的魔法，而是一套清晰的工程方法 —— 通过精心设计的算法和数学工具，解决 AI 领域的具体问题。学习 计算机视觉 能帮你理解 AI 系统「为什么这样工作」，以及「怎么改进它」。',
    analogy: '教机器像人眼一样看懂图片和视频。这个类比能帮助你快速建立对 计算机视觉 的直觉理解，把抽象的技术概念映射到熟悉的日常生活场景。',
    keyPoints: [
      "计算机视觉 是 AI 领域的重要概念，对应 Computer Vision",
      "核心思想：教机器像人眼一样看懂图片和视频",
      "主要应用场景：模型部署、推理加速、专业应用",
      "与 Computer Vision 相关的核心技术包括 Transformer、神经网络等",
      "在现代大语言模型生态中扮演重要角色"
    ],
    useCases: [
    ...
    relatedConcepts: [
      ...
      {conceptId: "gan", relationType: "can-extend", relationLabel: "可扩展"}
    ],
    resources: [
