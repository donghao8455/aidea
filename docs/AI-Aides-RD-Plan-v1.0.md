...
| 任务 | 子任务 | 预计工时 | 产出物 | 状态 |
|------|--------|---------|--------|------|
| **P1.1 图谱完整实现** | 15个概念节点渲染 | 2h | | ✅ 已完成 |
| | ~20条关系连线绘制 | 2h | | ✅ 已完成 |
| | 节点颜色按类别区分 | 1h | | ✅ 已完成 |
| | 层级树形布局 | 2h | | ✅ 已完成 |
| | 节点悬停 Tooltip | 3h | AC-002 | ✅ 已完成 |
| | 点击节点跳转详情页 | 2h | AC-003 | ✅ 已完成 |
| | 初始加载动画 | 2h | | ⏳ 待开始 |
| **P1.2 分类筛选** | 筛选 UI 组件 | 2h | | ✅ 已完成 |
| | 筛选逻辑实现 | 3h | AC-004 | ✅ 已完成 |
| | 灰显效果实现 | 1h | | ✅ 已完成 |
| **P1.3 全局搜索** | 搜索 UI 组件 | 2h | | ✅ 已完成 |
| | 搜索算法（模糊匹配） | 3h | AC-005 | ✅ 已完成 |
| | Ctrl+K 快捷键 | 1h | | ⏳ 待开始 |
| **P1.4 概念详情页** | 页面模板开发 | 3h | | ✅ 已完成 |
| | 面包屑导航 | 1h | | ✅ 已完成 |
| | 定义区块 | 1h | | ✅ 已完成 |
| | 类比区块 | 1h | | ✅ 已完成 |
| | 核心要点区块 | 1h | | ✅ 已完成 |
...
| | 延伸阅读区块 | 1h | | ✅ 已完成 |
| | 底部导航 | 1h | | ✅ 已完成 |
| **P1.5 响应式适配** | 桌面端 (1200px+) | 2h | P0 | ✅ 已完成 |
| | 平板端 (768px-1199px) | 2h | P1 | ⏳ 待开始 |
| | 移动端 (375px-767px) | **基础适配：1h**<br>仅保证可读、可滚动<br>手势交互降级为点击操作 | P2 | ⏳ 待开始 |
